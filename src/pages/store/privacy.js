...
const paragraphs = [
  ...
  'In Your Browser (pdfsign and Resume Maker)',
  'pdfsign and Resume Maker also run in a web browser, at yarpdevelopers.com/pdfsign and yarpdevelopers.com/resume-maker. This website delivers the app to your browser, and after that everything happens on your phone or computer: the PDFs you open, the resumes you write and the files you save are handled by your browser and are never uploaded, to us or anyone else. Resume Maker makes its PDF with your browser’s own print window. Your saved signatures and profile (pdfsign), your resumes (Resume Maker) and your licence key are kept in your browser’s own storage on that device, and clearing your browsing data deletes them. The browser versions have no analytics and no trackers. If you buy in the same browser, the thank-you page saves your key there too, so the browser version is unlocked straight away.',
  'Links You Click',
